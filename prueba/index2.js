...
function addListenerMulti(s, fn) {
  s.split(' ').forEach(e => document.addEventListener(e, fn, false));
}

addListenerMulti('mousedown touchstart', function(e) {
    e.stopPropagation();
  e.preventDefault();
...
addListenerMulti('mouseup touchend', function(e) {
  e.stopPropagation();
  e.preventDefault();
...
addListenerMulti('mousemove touchmove', function(e) {
  e.stopPropagation();
  e.preventDefault();
...
addListenerMulti('resize', function(e) {
...
function render() {
  ...
  //document.querySelector('.vector').remove();
  //VER
  $('body .vector').remove();
...
function renderVector(v, translate) {
  ...
  /*line.style.left = translate.x;
  line.style.top = translate.y;
  line.style.height = v.lenght();*/
  line.css({
    left: translate.x,
    top: translate.y,
    height: v.length()
